# A tool by nitro from Coding Zone
...
'
echo " " 
echo -e "$red                       ▶Coded by$grn Anonymous$red◀$rset"
echo -e "$red                      ⫸$ylo  Coding Zone$red ⫷$rset"
echo 
# Functions
...
then
am start -a android.intent.action.VIEW -d https://www.youtube.com/@codingzone1894 > /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
then
